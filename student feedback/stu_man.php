...
<div id="az461" class="navbar">
    ...
    <section class="main-11">
        ...
        <div id="S_m" class="info">
              <p class="Student-h2">Student List:</p>
                  ...
                  while( $result= mysqli_fetch_assoc($data))
                   {
                        ...
                        <td>".$result['f_name']."</td>
                         ...
                         <td>".$result['Course']."</td>
                         <td>".$result['Dob']."</td>
                         <td><a class='stu-a' href='update.php?rn=$result[Student_id] & fn=$result[f_name] & ln=$result[l_name] & pn=$result[Phone_no] & Dob=$result[Dob]'>Update</a></td>
                         <td><a class='stu-a' href='delete.php?rn=$result[Student_id]'>Delete</a></td>
                         </tr>
                          ";
                    }
                 }
