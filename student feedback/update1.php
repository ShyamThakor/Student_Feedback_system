...
error_reporting(0);
  if(Isset($_GET['Update']))
  {
    ...
    $Dob = $_GET['Dob'];
    // echo $f_name;
    $query="UPDATE registration set f_name='$f_name',l_name='$l_name',Phone_no='$Phone_no',Faculty_id='$Faculty_id',Dob='$Dob' where Faculty_id='$Faculty_id' ";
    // echo $query;
    // echo "<br>";
    // echo $con;
    ...
    else
    {
        ...
        window.location.href='faculty_man.php';
        </script>";  // echo mysqli_connect_error();
 ...
 <form class="form" methode="GET">
    ...
    <!-- <?php echo $p ?> -->
     ...
     <label class="F-id">Faculty No</label>
 		<input type="text" name="Facultyid" value= "<?php echo "$rn" ?>"      placeholder="Enter your No" id="Facultyid" required><br>
   <br> 
